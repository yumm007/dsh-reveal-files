...
window.__ModuleLoader__.load({ id: "dsh-reveal-files", factory: (require) => {
  ...
  var zh = {
    ...
    "reveal.terminal": "在终端中打开所在目录",
    "reveal.errorCopyPath": "拷贝失败",
    "reveal.errorReveal": "在文件浏览器中显示失败",
    "reveal.errorTerminal": "在终端中打开目录失败",
  ...
  var en = {
    ...
    "reveal.terminal": "Open the file's directory in terminal",
    "reveal.errorCopyPath": "Failed to copy",
    "reveal.errorReveal": "Failed to show in file browser",
    "reveal.errorTerminal": "Failed to open directory in terminal",
